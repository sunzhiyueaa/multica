...
export function RuntimeDetail({ runtime }: { runtime: AgentRuntime }) {
  ...
  const handleDelete = () => {
    deleteMutation.mutate(runtime.id, {
      onSuccess: () => {
        toast.success(t.runtimes.detail.deleted);
        setDeleteOpen(false);
      },
      onError: (e) => {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        {runtime.runtime_mode === "local" && (
          <div>
            <h3 className="text-xs font-medium text-muted-foreground mb-3">
              {t.runtimes.sections.cliVersion}
            </h3>
            <UpdateSection
        ...
        <div>
          <h3 className="text-xs font-medium text-muted-foreground mb-3">
            {t.runtimes.sections.connectionTest}
          </h3>
        ...
        <div>
          <h3 className="text-xs font-medium text-muted-foreground mb-3">
            {t.runtimes.sections.tokenUsage}
          </h3>
      ...
      <AlertDialog open={deleteOpen} onOpenChange={(v) => { if (!v) setDeleteOpen(false); }}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {t.runtimes.detail.deleteDescription.replace("{name}", runtime.name)}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            >
              {deleteMutation.isPending ? t.runtimes.detail.deleting : t.runtimes.detail.deleteConfirm}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
