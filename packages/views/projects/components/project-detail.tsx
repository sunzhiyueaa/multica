  ...
  if (projectIssues.length === 0) {
    return (
      <div className="flex flex-1 min-h-0 flex-col items-center justify-center gap-2 text-muted-foreground">
        ...
        <p className="text-sm">{t.projects.detail.noIssues}</p>
        <p className="text-xs">{t.projects.detail.noIssuesHint}</p>
      </div>
    );
  }
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        {propertiesOpen && <div className="space-y-0.5 pl-2">
          ...
          <PropRow label={t.projects.page.lead}>
                ...
                render={
                  <button type="button" className="inline-flex items-center gap-1.5 text-xs hover:text-foreground transition-colors">
                    {project.lead_type && project.lead_id ? (
                      ...
                      <span className="text-muted-foreground">{t.projects.detail.noLead}</span>
                    )}
                  </button>
                }
              />
              <PopoverContent align="start" className="w-52 p-0">
                <div className="px-2 py-1.5 border-b">
                  <input
                    ...
                    placeholder={t.projects.detail.assignLead}
                ...
                <div className="p-1 max-h-60 overflow-y-auto">
                  ...
                  {filteredMembers.length > 0 && (
                    <>
                      <div className="px-2 pt-2 pb-1 text-xs font-medium text-muted-foreground uppercase tracking-wider">{t.common.members}</div>
                  ...
                  {filteredAgents.length > 0 && (
                    <>
                      <div className="px-2 pt-2 pb-1 text-xs font-medium text-muted-foreground uppercase tracking-wider">{t.common.agents}</div>
                  ...
                  {filteredMembers.length === 0 && filteredAgents.length === 0 && leadFilter && (
                    <div className="px-2 py-3 text-center text-sm text-muted-foreground">{t.projects.detail.noResults}</div>
                  )}
                </div>
              </PopoverContent>
            </Popover>
  ...
  return (
    ...
    <ResizablePanelGroup orientation="horizontal" className="flex-1 min-h-0" defaultLayout={defaultLayout} onLayoutChanged={onLayoutChanged}>
          ...
          <PageHeader className="gap-2 bg-background text-sm">
            ...
            <div className="flex items-center gap-1 shrink-0">
              <Button
                ...
                title={isPinned ? t.common.unpinFromSidebar : t.common.pinToSidebar}
                onClick={() => {
                  if (isPinned) {
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-auto">
                  <DropdownMenuItem onClick={() => {
                    ...
                    toast.success(t.projects.detail.linkCopied);
                  }}>
                    <Link2 className="h-3.5 w-3.5" />
                    {t.projects.detail.copyLink}
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
                  <DropdownMenuItem
                    variant="destructive"
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>{t.projects.actions.deleteProject}</AlertDialogTitle>
            <AlertDialogDescription>
              {t.projects.detail.deleteDescription}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
