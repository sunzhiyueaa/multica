      ...
      <div className="flex-1 overflow-y-auto">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-muted-foreground">
            ...
            <p className="text-sm">{t.projects.page.noProjects}</p>
          ...
          <>
            ...
            <div className="sticky top-0 z-[1] flex h-8 items-center gap-2 border-b bg-muted/30 px-5 text-xs font-medium text-muted-foreground">
              {/* Icon spacer + Name */}
              <span className="shrink-0 w-[24px]" />
              <span className="min-w-0 flex-1">{t.projects.page.name}</span>
              <span className="w-24 text-center shrink-0">{t.projects.page.priority}</span>
              <span className="w-28 text-center shrink-0">{t.projects.page.status}</span>
              <span className="w-24 text-center shrink-0">{t.projects.page.progress}</span>
              <span className="w-10 text-center shrink-0">{t.projects.page.lead}</span>
              <span className="w-20 text-right shrink-0">{t.projects.page.created}</span>
            </div>
            {/* Rows */}
